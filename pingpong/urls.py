...
path('logout/', views.user_logout, name='logout'),
    ...
    path('tournament_name_user/', views.tournament_name_user, name='tournament_name_user'),
    ...
    path('second_player_tournament/<int:tournament_id>/', views.second_player_tournament, name='second_player_tournament'),
