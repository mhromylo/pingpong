...
export default class Player
{
	...
	constructor(name, isAI, paddleColour, paddleWidth, paddleHeight, paddleSpeed, paddleX, paddleY, moveUp, moveDown, canvasHeight, canvasWidth, shootButton, another_game_id, player_id)
	{
		this.name = name;
		this.isAI = isAI;
		...
		this.lastFiredDart = performance.now() - 330;
        this.another_game_id = another_game_id;
    ...
    keyDownHandler(e, dartsFlying, extrasAreOn, gameRunning) {
		...
		if ((e.key === this.shootButton || e.key === this.alternateShootButton) && extrasAreOn && (performance.now() - this.lastFiredDart) >= 330)
		{
